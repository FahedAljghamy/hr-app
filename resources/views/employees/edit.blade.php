{{-- 
Author: Eng.Fahed
Employees Edit View - HR System
صفحة تعديل بيانات الموظف
--}}

@extends('layouts.app')

@section('title', trans('messages.Edit Employee') . ': ' . $employee->full_name)

@section('content')
<!-- Page Heading -->
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        <h1 class="h3 mb-0 text-gray-800">{{ trans('messages.Edit Employee') }}</h1>
        <p class="text-muted">{{ trans('messages.Update employee information') }}: {{ $employee->full_name }}</p>
    </div>
    <div>
        <a href="{{ route('employees.show', $employee) }}" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm mr-2">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" required>
                        ...
                        <option value="male" {{ old('gender', $employee->gender) === 'male' ? 'selected' : '' }}>{{ trans('messages.Male') }}</option>
                        <option value="female" {{ old('gender', $employee->gender) === 'female' ? 'selected' : '' }}>{{ trans('messages.Female') }}</option>
                    </select>
                    @error('gender')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="employment_status" id="employment_status" class="form-control @error('employment_status') is-invalid @enderror">
                        @foreach($employmentStatuses as $key => $status)
                            <option value="{{ $key }}" {{ old('employment_status', $employee->employment_status) === $key ? 'selected' : '' }}>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="passport_expiry" id="passport_expiry" value="{{ old('passport_expiry', $employee->passport_expiry->format('Y-m-d')) }}" 
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="visa_number" id="visa_number" value="{{ old('visa_number', $employee->visa_number) }}" 
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="housing_allowance" id="housing_allowance" value="{{ old('housing_allowance', $employee->housing_allowance) }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="transport_allowance" id="transport_allowance" value="{{ old('transport_allowance', $employee->transport_allowance) }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="food_allowance" id="food_allowance" value="{{ old('food_allowance', $employee->food_allowance) }}" 
    ...
    <div class="card shadow">
        <div class="card-body text-center">
            <button type="submit" class="btn btn-primary btn-lg mr-3">
                <i class="fas fa-save mr-2"></i>{{ trans('messages.Update Employee') }}
            </button>
            <a href="{{ route('employees.show', $employee) }}" class="btn btn-secondary btn-lg">
