            ...
            <div class="col-md-6 col-lg-4">
                <div class="login-card">
                    <div class="login-header">
                        ...
                        <p>{{ __('Welcome back! Please sign in to your account.') }}</p>
                    </div>
                    ...
                    <div class="test-accounts">
                        <h6><i class="fas fa-info-circle me-2"></i>{{ __('Test Accounts') }}</h6>
                        <div class="test-account">
                            <strong>{{ __('Super Admin') }}:</strong><br>
                            superadmin@hrsystem.com / password123
                        </div>
                        <div class="test-account">
                            <strong>{{ __('Tenant Admin') }}:</strong><br>
